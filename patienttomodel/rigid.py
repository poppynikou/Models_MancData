...
for patient in patients:
    ...
    pCT_hn_3_path = 'T:/Poppy/PatData/HN_'+str(patient)+'/pCT/UCLHAtlas_Alignment/InitAlignment_MASKED_rescaled_pCT.nii.gz'

    ref_img = hn_atlas_path
    float_img = pCT_hn_3_path
    transformation = 'T:/Poppy/PatData/HN_'+str(patient)+'/pCT/UCLHAtlas_Alignment/atlas_rigid.txt'
    resampled_img = 'T:/Poppy/PatData/HN_'+str(patient)+'/pCT/UCLHAtlas_Alignment/resampled_pCT_atlas_rigid.nii.gz'
    ...
    updated_img = 'T:/Poppy/PatData/HN_'+str(patient)+'/pCT/UCLHAtlas_Alignment/RIGID_pCT.nii.gz'
    ...
    transformation = 'T:/Poppy/PatData/HN_'+str(patient)+'/pCT/UCLHAtlas_Alignment/atlas_affine.txt'
    resampled_img = 'T:/Poppy/PatData/HN_'+str(patient)+'/pCT/UCLHAtlas_Alignment/resampled_pCT_atlas_affine.nii.gz'
    ...
    affine = transformation
    updated_img = 'T:/Poppy/PatData/HN_'+str(patient)+'/pCT/UCLHAtlas_Alignment/AFFINE_pCT.nii.gz'
    command = reg_transform + ' -ref ' + img_to_be_updated + ' -updSform ' + img_to_be_updated + ' ' + affine + ' ' + updated_img
    os.system(command)
    # first align a patient rigidly 
